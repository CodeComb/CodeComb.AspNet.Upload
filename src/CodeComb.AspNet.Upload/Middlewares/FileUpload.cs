...
using CodeComb.AspNet.Upload.Middlewares;

namespace Microsoft.AspNet.Builder
{
    public static class FileUpload
    {
        public static IApplicationBuilder UseFileUpload(this IApplicationBuilder self, string path = "/scripts/jquery.codecomb.fileupload.js", string fileFormName="file", string controller = "file", string downloadAction = "download", string uploadAction="upload", string uploadRouteName="FileUpload", string downloadRouteName = "FileDownload")
        {
            #region Download
            ...
            routeBuilder1.ServiceProvider = self.ApplicationServices;
